...
const GOOGLE_FONTS = [
  { name: 'Syne', label: 'Syne (Brutalist Neo)' },
  { name: 'Space Grotesk', label: 'Space Grotesk (Tech Neo)' },
  { name: 'Bricolage Grotesque', label: 'Bricolage Grotesque (Eclectic)' },
  { name: 'Plus Jakarta Sans', label: 'Plus Jakarta Sans (Modern)' },
  { name: 'Instrument Serif', label: 'Instrument Serif (Editorial)' },
  { name: 'Fraunces', label: 'Fraunces (Soft Wonky Serif)' },
  { name: 'Chakra Petch', label: 'Chakra Petch (Cyberpunk)' },
  { name: 'Orbitron', label: 'Orbitron (Sci-Fi Display)' },
  { name: 'Cinzel', label: 'Cinzel (Roman Capitals)' },
  { name: 'JetBrains Mono', label: 'JetBrains Mono (Dev Mono)' },
  { name: 'Outfit', label: 'Outfit (Geometric UI)' },
  { name: 'DM Sans', label: 'DM Sans (Clean Geometric)' },
  { name: 'Righteous', label: 'Righteous (Retro Bold)' },
  { name: 'Playfair Display', label: 'Playfair Display (Classic Serif)' },
  { name: 'Unbounded', label: 'Unbounded (Wide Display)' },
  { name: 'Inter', label: 'Inter (Swiss Sans)' },
  { name: 'Bebas Neue', label: 'Bebas Neue (Condensed Impact)' },
  { name: 'Pacifico', label: 'Pacifico (Script Handwritten)' },
  { name: 'Fira Code', label: 'Fira Code (Ligature Mono)' },
  { name: 'Oswald', label: 'Oswald (Condensed Gothic)' },
  { name: 'Montserrat', label: 'Montserrat (Geometric Sans)' },
  { name: 'Poppins', label: 'Poppins (Rounded Modern)' },
  { name: 'Roboto Mono', label: 'Roboto Mono (Clean Mono)' },
  { name: 'Raleway', label: 'Raleway (Elegant Thin)' },
  { name: 'Archivo Black', label: 'Archivo Black (Heavy Impact)' },
  { name: 'Caveat', label: 'Caveat (Casual Handwriting)' },
  { name: 'Permanent Marker', label: 'Permanent Marker (Marker Pen)' },
  { name: 'Libre Baskerville', label: 'Libre Baskerville (Book Serif)' },
];
